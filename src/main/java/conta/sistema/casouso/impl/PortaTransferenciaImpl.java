package conta.sistema.casouso.impl;
...
@Named
public class PortaTransferenciaImpl implements PortaTransferencia {

    private final ContaRepositorio repositorio;
    private final Transferencia transferencia;

    @Inject
    public PortaTransferenciaImpl(ContaRepositorio repositorio, Transferencia transferencia) {
